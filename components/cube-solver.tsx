  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
                  ...
                  <Canvas camera={{ position: [8, 8, 8] }}>
                    ...
                    <Suspense fallback={null}>
                      <RubiksCube
                        state={cubeState}
                        size={cubeSize}
                        animatingMove={enableAnimations ? animatingMove : null}
                        onAnimationComplete={() => {}}
                      />
                    </Suspense>
            ...
            <AlgorithmVisualizer
              ...
              currentMove={currentMoveIndex >= 0 ? solutionMoves[currentMoveIndex] : null}
        ...
        <AlgorithmDialog algorithm={currentAlgorithm} open={dialogOpen} onOpenChange={setDialogOpen} />
      </div>
    </div>
  )
}
